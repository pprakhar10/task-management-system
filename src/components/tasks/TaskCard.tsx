...
export function TaskCard({
  ...
  const canMoveSubtasks = !!(onMoveSubtaskUp && onMoveSubtaskDown);
                ...
                {subtasks.map(subtask =>
                  editingSubtaskId === subtask.id ? (
                    ...
                    <div key={subtask.id} className="flex items-center">
                      ...
                      {(canEditSubtasks || canMoveSubtasks) && (
                        <div className="flex items-center gap-0.5 shrink-0 pr-1">
                          {canMoveSubtasks && (() => {
                            ...
                            return (
                              <>
                                <button
                                  onClick={() => onMoveSubtaskUp!(subtask.id, task.id)}
                                  disabled={idx === 0}
                                ...
                                <button
                                  onClick={() => onMoveSubtaskDown!(subtask.id, task.id)}
